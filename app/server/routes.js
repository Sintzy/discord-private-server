...
module.exports = function(app) {
	...
	app.get('/', function(req, res){
		...
		if (req.cookies.login == undefined){
			res.render('login', { title: 'Olá! Faça login com a sua conta' });
		}	else{
	...
	app.get('/reset-password', function(req, res) {
		AM.validatePasswordKey(req.query['key'], req.ip, function(e, o){
			if (e || o == null){
				...
				res.render('reset', { title : 'Resetar Password' });
			}
		})
	});
	...
	app.get('*', function(req, res) { res.render('404', { title: 'Pagina não encontrada'}); });
